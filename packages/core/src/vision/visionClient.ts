// packages/core/src/vision/visionClient.ts
import type { RgbaImage } from '../lib/image';
import type { Region } from '../lib/region';
import type { AssembledPosition } from './position';
import type { Orientation } from './types';

/** Structural shape of the main-thread capturer VisionTracker drives — satisfied by the
 *  desktop Tauri `Capturer` and by the extension's tab capturer. Keeps core free of Tauri. */
export interface CapturerLike {
